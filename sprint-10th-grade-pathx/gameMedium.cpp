...
void StartMediumGame() {
    InitWindow(0, 0, "MEDIUM MAZE"); ToggleFullscreen();
    ...
    while (!WindowShouldClose()) {
        ...
        if (GetTime() - lastBlinkTime > GetRandomValue(5, 6)) {
            showMaze = !showMaze;
        ...
        DrawCircle(px * CELL_SIZE + CELL_SIZE / 2, py * CELL_SIZE + CELL_SIZE / 2, CELL_SIZE * 3, WHITE);
